...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date-ErfanGSI-YuiGSIs"
...
sed -i "s/$bdisplay/$displayid2=Built\.with\.ErfanGSI\.Tools\.YuiGSIs/" $systemdir/system/build.prop
